# QuantumShield: Quantum & Machine Learning Drug-Discovery Pipeline
...
* **Molecular Dynamics (MD) Simulation**: Models dynamic coordinate changes and structural stability of ligand-protein systems under physiological temperatures (310.15 K).
* **DNA Interaction & Docking Analysis**: Performs in-silico docking potential calculations, binding affinity estimation ($\Delta G$), and dissociation constant ($K_d$) screening.
...
* **Interactive Dashboard**: React + TypeScript + Vite frontend offering real-time control over active space sizes (qubits/orbitals), ansatz transpilation metrics, noise parameters, and convergence curves.

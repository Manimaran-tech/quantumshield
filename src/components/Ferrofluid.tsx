...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  float distortdistort2 = vn(p - perp * (t * spd), 120.0, 15.0) * 100.0 * uTurbulence;

  float peaks = dbn(p + distort1 + dir * (t * spd * 0.5), 40.0, 1.0);
  float peaks2 = dbn(p + distortdistort2 - dir * (t * spd * 0.5), 40.0, 0.0);
  ...
  float spec = pow(clamp(ltn / max(uGlow, 0.01), 0.0, 1.0), 3.0) * 0.6;
  vec3 outc = (col * ltn + vec3(spec)) * uOpacity;
